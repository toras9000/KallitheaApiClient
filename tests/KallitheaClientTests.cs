...
public class KallitheaClientTests
{
    ...
    public async Task UpdateRepoGroupAsync_Move()
    {
        ...
        var grpA = (await client.CreateRepoGroupAsync(new("GrpA", parent: repogroup.Entity.group_name))).result.repo_group;
        var grpB = (await client.CreateRepoGroupAsync(new("GrpB", parent: repogroup.Entity.group_name))).result.repo_group;
