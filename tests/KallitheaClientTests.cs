...
public class KallitheaClientTests
{
    ...
    public async Task GetRepoAsync_Fields()
    {
        ...
        response.result.revs.Should().NotBeNull();
        response.result.repo.extra_fields.Should().Contain(new ExtraField("testkey1", "testvalue1"));
        response.result.repo.extra_fields.Should().Contain(new ExtraField("testkey2", "testvalue2"));
    }
